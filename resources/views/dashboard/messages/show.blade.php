                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mx-auto">
                                        <div class="card-body bg-gray-100 border-radius-lg">
                                            <span class="mb-2">Nama Pengirim: <span class="text-dark font-weight-bold ms-sm-2">{{ $message->name }}</span></span><br>
                                            <span class="mb-2">Email: <span class="text-dark font-weight-bold ms-sm-2">{{ $message->email }}</span></span><br>
                                            <span class="mb-2">Subject: <span class="text-dark font-weight-bold ms-sm-2">{{ $message->subject }}</span></span><br>
                                            <span class="mb-2">Pesan: <span class="text-dark font-weight-bold ms-sm-2">{{ $message->message }}</span></span>
                                            {{-- <div class="rating">
                                                <h6 class="text-sm">{{ $message->email }}</h6> --}}
                                            {{-- </div>
                                            <h6 class="mb-0 mt-3">Harga</h6>
                                            <h5>Rp {{ $message->subject }}</h5>
